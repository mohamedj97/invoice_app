...
part of 'company_register_request_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CompanyRegisterRequestModel _$CompanyRegisterRequestModelFromJson(
    ...
    CompanyRegisterRequestModel(
      ...
      taxAuthority: json['taxAuthority'] as int?,
      active: json['active'] as bool,
    );

Map<String, dynamic> _$CompanyRegisterRequestModelToJson(
        CompanyRegisterRequestModel instance) =>
    <String, dynamic>{
      'id': instance.id,
      'code': instance.code,
      'name': instance.name,
