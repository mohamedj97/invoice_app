...
class UsersRepositoryImpl extends UsersRepository with ConnectivityMixin {
  ...
  @override
  Future<Either<Failure, AddUserResult>> getSingleUser({required int id}) async {
    try {
  ...
  @override
  Future<Either<Failure, AddUserResult>> addUser({required UserRequest userRequest}) async {
    try {
